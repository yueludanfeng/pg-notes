...
title: "问题现象"
date: 2025-05-27
description: "备份进程命令pg_start_backup()被checkpoint进程阻塞，checkpoint被逻辑复制walsender进程阻塞。业务虽然还在继续运行，但是备份、checkpoint、逻辑复制全部hang死。"
categories: ["PostgreSQL 运维"]
tags: ["WAL", "内存管理", "分区表", "参数配置", "备份恢复", "流复制", "逻辑复制", "锁"]
series: []
---
