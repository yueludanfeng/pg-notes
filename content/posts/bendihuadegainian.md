...
title: "本地化的概念"
date: 2025-05-27
description: "本地化的目的是支持不同国家、地区的语言特性、规则。比如拥有本地化支持后，可以使用支持汉语、法语、日语等等的字符集。除了字符集以外，还有字符排序规则和其他语言相关规则的支持，例如我们知道('a','b')该如何排序，那么('a','A')和("
categories: ["PostgreSQL 笔记"]
tags: ["参数配置", "安装部署", "执行计划", "索引", "统计信息"]
series: []
---
